    ...
    return (
        <div className="">
            <table className="table-auto">
                <thead>
                    <tr>
                        <th colSpan="3" className="text-left">Teachers</th>
                    </tr>
                    <tr>
                ...
                <thead>
                    <tr>
                        <th colSpan="3" className="text-left">Classmates</th>
                        <td className="text-gray-600 px-6 py-2">?? People</td>
                    </tr>
                    <tr>
                        <td colspan="4" class="p-0">
                            <div class="border-t border-gray-400"></div>
                ...
                <tbody>
                    <tr>
                        <td className="px-6 py-2">
                        <svg class="w-8 h-8 text-gray-800 dark:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
